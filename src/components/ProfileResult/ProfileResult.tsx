...
const IconBrokenHeart = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 6.5 3 4.8 4.6 3.8L13 12l-1 9.35zm5.4-17.5c1.4.9 2.6 2.6 2.6 4.7 0 3.78-3.4 6.86-8.55 11.54L12 21.35l1-9.35 8.6-8.15z" />
  </svg>
);
